...
import './App.css'; // Updated animations here
  ...
  return (
    <div className="space-y-8">
      <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight text-gray-900">
        Smart{' '}
        <span className="bg-gradient-to-r from-indigo-500 via-purple-500 to-violet-500 bg-clip-text text-transparent animate-gradient-slow">
          SCHOOL
        </span>{' '}
        Management System
      </h1>
      ...
      <div className="pt-8">
        <Link
          to="/login"
          className="inline-flex items-center space-x-2 bg-indigo-600 text-white px-8 py-4 rounded-xl text-lg font-semibold transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 border-2 border-indigo-500 hover:border-purple-700"
    ...
    <div className="min-h-screen">
      ...
      <nav className="relative z-10 px-4 sm:px-6 lg:px-8 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <Link
            to="/login"
            className="inline-flex items-center space-x-2 bg-indigo-600 text-white px-4 py-2 rounded-lg text-base font-medium border-2 border-indigo-500 hover:border-purple-700 transition-colors duration-500 shadow-lg hover:shadow-2xl transform hover:-translate-y-1"
    ...
    <>
      ...
      <Routes>
        ...
        <Route
          ...
          element={<ProtectedRoute allowedRoles={['teacher']}><DashboardLayout><TeacherDashboard /></DashboardLayout></ProtectedRoute>}
        />
        <Route
        ...
        <Route
          ...
          element={<ProtectedRoute allowedRoles={['teacher']}><DashboardLayout><MyLeave /></DashboardLayout></ProtectedRoute>}
        />
        <Route
          path="/teacher/substitutions"
          element={<ProtectedRoute allowedRoles={['teacher']}><DashboardLayout><TeacherSubstitutions /></DashboardLayout></ProtectedRoute>}
        />
        <Route
        ...
        <Route
          ...
          element={<ProtectedRoute allowedRoles={['admin']}><DashboardLayout><ScheduleEditor /></DashboardLayout></ProtectedRoute>}
        />
        <Route
          path="/admin/manage-teachers"
          element={<ProtectedRoute allowedRoles={['admin']}><DashboardLayout><ManageTeachersPage /></DashboardLayout></ProtectedRoute>}
        />
        <Route
          path="/admin/manage-leaves"
          element={<ProtectedRoute allowedRoles={['admin']}><DashboardLayout><ManageLeaves /></DashboardLayout></ProtectedRoute>}
        />
        <Route
          path="/admin/substitutions"
          element={<ProtectedRoute allowedRoles={['admin']}><DashboardLayout><AdminSubstitutions /></DashboardLayout></ProtectedRoute>}
        />
      </Routes>
      <Chatbot />
    </>
